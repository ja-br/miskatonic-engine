...
// No-discard variant for alpha-blend and additive pipelines
// These pipelines use blend equations to handle transparency, so discard is wrong
export const simpleLambertNoDiscardShader = `
// Retro Lambert shader - VERTEX lighting only (PS1/PS2 style)
// No discard - lets blend equation handle transparency
