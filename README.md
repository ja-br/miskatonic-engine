...
### "Batteries Included, Swappable Preferred"
- Provide excellent default implementations (Rapier physics, WebGPU rendering)
- Design abstractions for extensibility (swap physics engines, custom renderers)
- Clean interfaces allow full customization
...
**CRITICAL: Package READMEs must be concise and scannable. Avoid these common bloat patterns:**
